...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -400345543;
...
fn wire_show_toast_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse((move || {
                Result::<_, ()>::Ok(crate::api::simple::show_toast(api_message))
            })())
        },
    )
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        2 => wire_show_toast_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
